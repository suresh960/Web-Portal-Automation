...
async function autojoinMeeting() {
    ...
    try {
       ...
       // Wait for the next page to load (adjust the selector to a post-login element)
        ...
        const sessionXPath = "/html/body/div/div[1]/div/div/main/div[2]/div/div[2]/div[2]/div[2]/div[2]/button[1]";
        ...
        await driver.wait(until.urlContains('https://portal.argenie.ai/Sessions'), 10000);
